            ...
            <div class="card-body">
                ...
                <table class="table table-striped" id="table-1">
                    ...
                    <tr>
                        ...
                        <td class="font-weight-600">{{$p->jenis_cuti}}</td>
                        <td class="font-weight-600">{{$p->alasan_cuti}}</td>
                        <td class="font-weight-600">{{$p->atasan}}</td>
                        <td class="align-middle font-weight-600">{{$p->tgl_mulai}}</td>
                        <td class="align-middle font-weight-600">{{$p->tgl_akhir}}</td>
